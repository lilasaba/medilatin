...
With the exception of the Hungarian knowledge-based model (described in Section~\ref{g2p}), the 112-hor broadcast news set was used for training.
...
The results for the Czech-Hungarian-Polish joint acoustic model are in Table~\ref{tbl:three_language_usg}.
This setting yielded to a competitive overall $21.9\%$ WER. 
...
When adding Romanian, we got the best experimental results of $20.4\%$ with the four-language USG model.
