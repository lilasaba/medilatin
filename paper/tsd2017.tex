...
\item Support recognition of medieval Latiin spoken by speakers of a diverse native language background.
\end{enumerate}
...
The best performing monolingual grapheme-base model results were that of Hungarian, with $45.8\%$ overall WER (see Table~\ref{tbl:baseline}) - this was the reference value when comparing the results.
...
\parbox{.45\linewidth}{
\centering
\caption{Roman grapheme-based baseline model. Size of acoustic model: 35 hours.}
\input{tables/ro_grapheme.tex}
}
\hfill
\parbox{.45\linewidth}{
\centering
