...
The baseline acoustic models we start with are monolingual grapheme-based ones (depending of the language resources available) for these three languages. 
...
On the other hand, applying a simplified-unified grapheme (USG) inventory set for the three-language acoustic data set complemented with Romanian speech data yielded in competitive results - without using any target or source language G2P rules.
