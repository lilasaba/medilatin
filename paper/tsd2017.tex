...
The knowledge-based pronunciation modeling technique, where the source model is a phoneme-based acoustic model, and the source phonemes are mapped to the target phonemes in the pronunciation dictionary...
