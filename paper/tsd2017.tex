...
On a related note, we also found that teh Hungarian and Polish monolingual grapheme-based acoustic models had the best performance over their own test sets.
...
Cmplemented with Polish, we got the best experimental results of $20.4\%$ with the four-language USG model (see in Table~\ref{tbl:cz_hu_pl_ro_usg}).
