...
We also measured the WER on any combination of three of the four languages, and found that each language contribued to the four-language model.
...
When comparing it to the knowledge-based Hungarian phoneme-based model, which was using expert knowledge and trained on larger amount of data, it seemed that the four-language USG model was better in evening out the inconsistencies of the pronunciations in different speaker test sets.
