...
% ez már nem kell ide szerintem, mert a táblázat többet mond: (e.g. \texttt{\v{r}} to \texttt{r}, \texttt{\'{i}} to \texttt{i}, etc.).
...
% talán még jobb lenne azt mondani, hogy mennyiről mennyire csökkent a grapheme inventory szám
